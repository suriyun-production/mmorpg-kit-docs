...
You can set type of animator, there are:
...
## Other Animation Clip Settings

For this section, You should know about [Action Animation](pages/110-action-animation).

There are default action animation settings:
...
There are specific animation settings:
