...
- Added a `DISABLE_ADDRESSABLES` compile condition to disable Addressables features. It is now disabled by default to prevent common Addressables-related errors. Using Addressables properly is still recommended for better performance.
...
- [2844](https://github.com/suriyun-production/mmorpg-kit-docs/issues/2844)

* * *

## 1.96d
### Bug Fixes
- [2847](https://github.com/suriyun-production/mmorpg-kit-docs/issues/2847)

### Improvements
- [2846](https://github.com/suriyun-production/mmorpg-kit-docs/issues/2846)

* * *

## 1.96c
### Bug Fixes
- [2843](https://github.com/suriyun-production/mmorpg-kit-docs/issues/2843)
- [2840](https://github.com/suriyun-production/mmorpg-kit-docs/issues/2840)
