...
*   **/add\_item {item id} {amount}**, Add item to character inventory. For example, **/add\_item sword 1**, will add 1 sword to the character. **\*\* Item ID is Item data file name \*\***
*   **/give\_gold {character name} {gold amount}**, Add gold amount to specific character
*   **/give\_item {character name} {item id} {amount}**, Add item to specific character